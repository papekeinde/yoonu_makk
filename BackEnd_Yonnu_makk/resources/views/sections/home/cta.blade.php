    ...
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6">
        <div class="relative overflow-hidden rounded-[2rem] border border-yoonu-100 bg-gradient-to-br from-yoonu-700 to-yoonu-900 p-8 sm:p-12">
            ...
            <div class="relative">
                ...
                <p class="mt-3 max-w-2xl text-[15px] leading-8 text-white/80">Découvrez la plateforme YOONU MAKK côté patiente, accompagnant, gynécologue ou administration, dans une expérience simple et lisible.</p>
