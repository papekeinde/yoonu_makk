...
backup_path = input_path.with_name(input_path.stem + '_backup.docx')
...
with ZipFile(input_path, 'r') as zin, ZipFile(input_path, 'w', compression=ZIP_DEFLATED) as zout:
            ...
            for style in root.findall('.//w:style', ns):
                ...
                if sid in ('TM2', 'TM3'):
                    ...
                    if ind is None:
                        ...
                        ind.set('{%s}left' % ns_uri, '240' if sid == 'TM2' else '480')
