...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.contenus.update', $contenu->id) }}" enctype="multipart/form-data"
          class="rounded-2xl border border-gray-200 dark:border-white/[0.06] bg-white dark:bg-[#25101A] p-6">
        @csrf @method('PUT')
        @include('admin.contenus._form', ['submitLabel' => 'Enregistrer les modifications'])
    </form>
@endsection
